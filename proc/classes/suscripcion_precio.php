...
class SuscripcionPrecio
{
    ...
    function __construct($id, $id_suscripcion, $precio, $fecha_desde, $fecha_hasta)
    {
        $this->id = $id;
    ...
    static private function mysqli_to_instances($result)
    {
        ...
        if ($result) {
            while ($row = mysqli_fetch_array($result)) {
                $instance = new SuscripcionPrecio(
                    $row['id'],
                    $row['id_suscripcion'],
                    $row['precio'],
                    $row['fecha_desde'],
    ...
    static public function get_precios_suscripcion($id)
    {
        $q = mysqli_query(Auth::$mysqli, "SELECT * FROM suscripcion_precios WHERE id_suscripcion = " . $id . " ORDER BY fecha_desde ASC");
        return SuscripcionPrecio::mysqli_to_instances($q);
    }
